...
> 本文遵循 [org glossary](../user/architecture/glossary.md)。产品隔离边界称 Tenant；底层资源只称 one shared platform Temporal Namespace 与 one shared platform Kubernetes Namespace。
