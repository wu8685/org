...
> Terminology: this specification follows the canonical [org glossary](../../user/architecture/glossary.md). Product isolation is a Tenant; infrastructure uses the shared platform Temporal Namespace and platform Kubernetes Namespace.
