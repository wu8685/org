...
> Terminology follows the canonical [org glossary](../../user/architecture/glossary.md). This command operates only on this repository's local demo and the fixed `kind-org` development target.
