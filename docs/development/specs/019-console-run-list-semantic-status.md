...
> Terminology follows the canonical [org glossary](../../user/architecture/glossary.md). Product isolation is always a Tenant; this feature does not expose either platform Namespace.
