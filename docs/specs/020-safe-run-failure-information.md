...
> Terminology follows the canonical [org glossary](../architecture/glossary.md). This amendment exposes product-safe Workflow failure information; it never exposes platform Namespace, Temporal history, credentials or raw Worker errors.
