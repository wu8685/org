...
> Terminology follows the canonical [org glossary](../architecture/glossary.md). A Tenant is the product authorization and data boundary. It is never mapped to, or presented as, a platform Temporal Namespace or platform Kubernetes Namespace.
