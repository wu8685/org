...
image_repository=${IMAGE_REPOSITORY:-org.local/parallel-confirmation-worker}
image_tag="$image_repository:$VERSION-$COMMIT"
source_repository=${SOURCE_REPOSITORY:-https://github.com/wu8685/org-sample-parallel-confirmation}
