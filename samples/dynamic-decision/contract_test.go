...
func TestImageAndKindFilesExposeReproducibleBuildContract(t *testing.T) {
	checks := map[string][]string{
		"Dockerfile":             {"COPY go.mod go.sum", "COPY sdk ./sdk", "COPY samples/dynamic-decision", "org.opencontainers.image.version", "org.opencontainers.image.revision", "USER 65532:65532", "ENTRYPOINT"},
