...
func LoadConfig(getenv func(string) string) (Config, error) {
	cfg := Config{
		...
		TemporalWorkerDeployment: strings.TrimSpace(getenv("TEMPORAL_WORKER_DEPLOYMENT")),
	...
	required := map[string]string{
		...
		"TEMPORAL_WORKER_DEPLOYMENT": cfg.TemporalWorkerDeployment,
		"TEMPORAL_WORKER_BUILD_ID":   cfg.TemporalWorkerBuildID,
	}
	var missing []string
